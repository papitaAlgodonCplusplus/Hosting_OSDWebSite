...
export class LoginComponent implements OnDestroy {
  ...
  private createLoginForm(): FormGroup {
    ...
    return this.formBuilder.group({
      email: ['platformuserdefault@gmail.com', [Validators.required, this.validationsService.isValidEmail], []],
      password: ['Default1234', [Validators.required, this.validationsService.isValidPassword, Validators.minLength(6)], []],
    });
  }
